(function(){
      ...
      /* ==================الأنظمة================== */
      var softwareSystems = [
        { slug:'tms', icon:'warehouse', tag:'خياطة وتفصيل', name:'Holool TMS — نظام إدارة الخياطة', desc:'برنامج سطح مكتب يعمل دون إنترنت ويدعم العربية والإنجليزية. أدِر العملاء والمقاسات والطلبات والأقمشة والمبيعات ومدفوعات بنكك من مكان واحد.' },
        { slug:'gym', icon:'attendance', tag:'نوادٍ رياضية', name:'Holool GYM — إدارة النادي الرياضي', desc:'برنامج Windows يعمل دون إنترنت لإدارة الأعضاء والاشتراكات والحضور والمدربين والمصروفات والمخزون ونقطة البيع. جرّبه مجاناً لمدة 7 أيام.' },
        { slug:'pharmacy', url:'https://pms.holoolsoftware.com/', icon:'pharmacy', tag:'صيدليات', name:'نظام إدارة الصيدليات', headline:'صيدليتك مترابطة، من الرف إلى القرار.', desc:'رقمنة المبيعات والمخزون والصلاحيات والتقارير، مع تشغيل محلي ومزامنة سحابية تلقائية.', features:['بيع سريع وتتبع دقيق للأدوية','تنبيهات النواقص والصلاحية','تقارير موحدة للفروع'], outcome:'مخزون أدق وخدمة أسرع ورؤية كاملة للصيدلية.' },
        { slug:'labs', icon:'labs', tag:'معامل طبية', name:'Holool LMS — نظام إدارة المعامل', desc:'نظام Windows محلي يربط الاستقبال والتحصيل والعينات والنتائج والتأمين والمخزون. ثبّته على جهاز رئيسي واحد، ودَع فريقك يعمل معاً عبر شبكة المعمل.' },
      ...
      var renderSoftwareCard = function(s){
        return '<article class="software-card' + (s.comingSoon ? ' coming-soon' : '') + '">' +
          ...
          '<h3>' + s.name + '</h3>' +
          '<p>' + s.desc + '</p>' +
          '<a class="product-link" href="' + (s.url || 'software/' + s.slug + '/') + '">' + (s.url ? 'افتح صفحة النظام' : 'اكتشف النظام') + ' <span aria-hidden="true">←</span></a>' +
        '</article>'; };
